...
class PostController{
	...
	static public function postRegister($table, $data, $suffix){
		...
		if(isset($data["password_".$suffix]) && $data["password_".$suffix] != null){
				...
				if(isset($response["comment"]) && $response["comment"] == "La actualización fue correcta." ){
					...
					=============================================*/
						...
						if(isset($update["comment"]) && $update["comment"] == "La actualización fue correcta." ){
	...
	/*=============================================
		...
		if(!empty($response)){
			...
			/*=============================================
			Actualizamos el Token para usuarios legueados desde app externas
			=============================================*/
			...
			$response = null;
			$return = new PostController();
			$return -> fncResponse($response, "Correo electronico incorrecto",$suffix);
	...
	/*=============================================
	Quitamos la contraseña de la respuesta para no llegue al cliente
	=============================================*/
